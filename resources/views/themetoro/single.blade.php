...
@section('content')
    ...
    <section>
        ...
        <div class="single-blade MovieListTop owl-carousel" data-total-item="{{count($movie_related)}}" data-per-row="{{get_theme_option('movie_related_per_row', 5)}}" data-max-row="{{get_theme_option('movie_related_max_row', 2)}}">
