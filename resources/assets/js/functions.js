        ...
        function d() {
            var a = e.filter(function() {
                ...
                if ("none" != i.css("display")) {
                    var a = void 0 !== window.innerHeight ? window.innerHeight : o.height(),
                        e = o.scrollTop(),
                        r = e + a,
                        l = i.offset().top;
...
(function($) {
    ...
    $.ratePicker = function(target, options) {
        ...
        $(target).append($("<i>", {
            ...
            style: "color: transparent; font-size: 0;"
        }));
    ...
    (function() {
        ...
        var carouselOptions = {
          ...
          responsive: {
            ...
            991: {
              items: perRow,
              rows: totalRow //custom option not used by Owl Carousel, but used by the algorithm below
            }
          }
        };
